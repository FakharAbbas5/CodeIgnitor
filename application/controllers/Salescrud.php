...
class Salescrud extends CI_Controller
{
    ...
    public function addSales()
    {
        ...
        if(empty($data['Sales_Id']) || empty($data['Product_Name']) || empty($data['Salesman_Name']) ||
            empty($data['Date']) || empty($data['Quantity']) || empty($data['Sale_Price']) ||
        ...
        {
            $myreturn=$this->modsales->addSales($data);
            if($myreturn)
            {
    ...
    {
        $data['allSales']=$this->modsales->getAllRecords();
